...
The  JavaScript runtime of  [Weex](http://weex.apache.org/)  is  different from other's.  you can also easily use fly in WeChat [Weex](http://weex.apache.org/)  application:
